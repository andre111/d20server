...
export class DirectoryActionDelete extends DirectoryAction {
    ...
    applyTo(directory) {
        ...
        new CanvasWindowConfirm(this.window, I18N.get('filemanager.action.directory.delete.title', 'Delete directory'), I18N.get('filemanager.action.directory.delete.question', 'Do you want to delete "%0" and all of its contents?', directory.getName()), () => {
