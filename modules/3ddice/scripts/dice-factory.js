class DiceFactory {
	constructor() {
		...
		diceobj.name = 'Coin';
		diceobj.setLabels([
			'/public/3ddice/textures/coin/tail.webp',
			'/public/3ddice/textures/coin/heads.webp'
		]);
		diceobj.setBumpMaps([
			'/public/3ddice/textures/coin/tail_bump.webp',
			'/public/3ddice/textures/coin/heads_bump.webp'
		]);
