...
export class DiceFactory {
	constructor() {
		...
		diceobj.name = 'Coin';
		diceobj.setLabels([
			'/modules/3ddice/files/textures/coin/tail.webp',
			'/modules/3ddice/files/textures/coin/heads.webp'
		]);
		diceobj.setBumpMaps([
			'/modules/3ddice/files/textures/coin/tail_bump.webp',
			'/modules/3ddice/files/textures/coin/heads_bump.webp'
		]);
		...
		this.applyColorSet(DiceColors.getColorSet('black'));
	}
	...
	register(diceobj) {
		...
		if (diceobj.modelFile && !diceobj.modelLoaded)
			diceobj.loadModel();
	}
